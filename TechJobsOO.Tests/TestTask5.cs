...
namespace TechJobsOO.Tests
{
    ...
    public class TestTask5
    {
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            //setup
            string text = System.IO.File.ReadAllText("/Users/briarispastiche/Projects/csharp-web-dev-examples/csharp6-assignment-2-techjobs-oo-coderBrie/TechJobsOO.Tests/StartsAndEndsWithNewLine.txt").ToString();
        ...
        public void Test_TestToStringHandlesEmptyField()
        {
            //comparing output to a text file.
            //id numbers may get a little wonky
            string text = System.IO.File.ReadAllText("/Users/briarispastiche/Projects/csharp-web-dev-examples/csharp6-assignment-2-techjobs-oo-coderBrie/TechJobsOO.Tests/EmptyFieldTest.txt").ToString();
            var stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
            var job = new RunTechJobs();
            job.RunProgram();
